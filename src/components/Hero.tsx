...
const Hero: React.FC = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-screen flex flex-col md:flex-row justify-center items-center text-white py-20 px-4 sm:px-6 lg:px-8"
      id="home"
    >
      <motion.div
        initial="hidden"
      ...
      >
        ...
        <motion.div className="flex gap-4" transition={{ delay: 0.5 }}>
          <a
            href="#contact"
      ...
      >
        <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 p-1">
